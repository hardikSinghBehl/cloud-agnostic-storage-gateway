package com.behl.strongbox.security.utility;
...
import com.behl.strongbox.configuration.properties.JwtConfigurationProperties;
...
public class JwtUtility {
	...
	public String generateAccessToken(@NonNull final User user) {
		...
		return createToken(claims, user.getUserName(),
				TimeUnit.DAYS.toMillis(jwtConfigurationProperties.getJwt().getAccessToken().getValidity()));
	}
